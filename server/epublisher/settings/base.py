"""
Django settings for epublisher project.
...
SECRET_KEY = '$p0u*x3g9y+46r0!@kypfcra=n76wn&p++o-ph(1(*pu10(aw8'
...
MIDDLEWARE = [
    ...
    'epublisher.middleware.ForceDefaultLanguageMiddleware',
...
WSGI_APPLICATION = 'epublisher.wsgi.application'
