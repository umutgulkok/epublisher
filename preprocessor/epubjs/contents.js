...
const {isNumber, prefixed, borders, defaults} = require("./utils/core");
const EpubCFI = require("./epubcfi");
const Mapping = require("./mapping");
const {replaceLinks} = require("./utils/replacements");
const { EPUBJS_VERSION, EVENTS, DOM_EVENTS } = require("./utils/constants");
...
class Contents {
	...
	resizeListeners() {
        ...
        setImmediate(this.resizeCheck.bind(this));
