...
const {extend, borders, uuid, isNumber, bounds, defer, qs, parse} = require("epubjs/utils/core");
const EpubCFI = require("epubjs/epubcfi");
const Contents = require("epubjs/contents");
const { EVENTS } = require("epubjs/utils/constants");
