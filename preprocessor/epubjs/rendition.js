...
const { extend, defer, isFloat } = require("./utils/core");
...
const { EVENTS, DOM_EVENTS } = require("./utils/constants");
...
const DefaultViewManager = require("./managers/default/index");
const ContinuousViewManager = require("./managers/continuous/index");
