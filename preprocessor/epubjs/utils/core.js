 ...
 * @memberof Core
 */
const NodeFilter = require("jsdom/lib/jsdom/living/node-filter");


// module.exports const requestAnimationFrame = (typeof window != "undefined") ? (window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame) : false;
